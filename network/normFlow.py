...
class LinLayer(NormFlowLayer):
    ...
    def setParamValues(self,w,b,u):
        self.w.set_value( np.asarray(w,dtype=floatX) )
        self.b.set_value( np.asarray(b,dtype=floatX) )
        self.u.set_value( np.asarray(u,dtype=floatX) )
